...
Now can you see? We know exactly why the correct point is there. Because there's a black hole, or a steep hole in that point, that pull our correct answer there. Where everywhere else in the graph, is a high point that restrict the position of our data. Now, this problems become interpretable and something we can understand. So that's the strength of energy based models

But there's more to this. We have to cover that in the next part. Thank you

![](/Screenshot%202025-11-23%20at%208.16.43%E2%80%AFAM.png)
